...
<div id="search-outer" class="nectar gmh">
		     	...
		     	<div class="inner-wrap">
			     	...
			     	<div class="col span_12">
				      	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="GET">
				      		...
				      		<?php } else { ?> 
				      			<input  class="gmh--input-suche" type="text" name="s" <?php if($ajax_search == 'yes') { echo 'id="s"'; } ?> placeholder="Suchbegriff eingeben" data-placeholder="<?php echo __('uchbegriff eingeben', NECTAR_THEME_NAME); ?>" />
				      		<?php } ?>
				      	</form>
								
				      	<?php if($theme_skin == 'ascend' && $ajax_search == 'no') { echo '<span><i>'.__("Enter drücken, um mit der Suche zu beginnen",NECTAR_THEME_NAME).'</i></span>'; }
